    ...
    <nav class="bg-brand-dark fixed w-full z-50 shadow-lg border-b border-brand-primary transition-all duration-300"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6 space-x-8">
                    ...
                    <a href="{{ route('about') }}" class="relative text-white transition font-medium hover:text-brand-cyan after:content-[''] after:absolute after:left-0 after:-bottom-1 after:h-0.5 after:w-0 after:bg-brand-cyan after:transition-all after:duration-300 hover:after:w-full">About Us</a>
                    <a href="{{ route('services') }}" class="relative text-white transition font-medium hover:text-brand-cyan after:content-[''] after:absolute after:left-0 after:-bottom-1 after:h-0.5 after:w-0 after:bg-brand-cyan after:transition-all after:duration-300 hover:after:w-full">Services</a>
                    <a href="{{ route('projects') }}" class="relative text-white transition font-medium hover:text-brand-cyan after:content-[''] after:absolute after:left-0 after:-bottom-1 after:h-0.5 after:w-0 after:bg-brand-cyan after:transition-all after:duration-300 hover:after:w-full">Projects</a>
                    <a href="{{ route('contact') }}" class="relative text-white transition font-medium hover:text-brand-cyan after:content-[''] after:absolute after:left-0 after:-bottom-1 after:h-0.5 after:w-0 after:bg-brand-cyan after:transition-all after:duration-300 hover:after:w-full">Contact</a>
                </div>
        ...
        <div x-show="open" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 -translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-100" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 -translate-y-2" class="sm:hidden border-t border-brand-primary/40 bg-brand-dark/95 backdrop-blur">
            <div class="px-4 py-4 space-y-3">
                ...
                <a href="{{ route('contact') }}" class="inline-flex items-center justify-center px-5 py-2 bg-brand-cyan text-brand-dark font-bold rounded-lg hover:bg-cyan-300 transition w-full">Contact Us</a>
            </div>
        </div>
    </nav>
        ...
        <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="{{ route('services') }}" class="footer-quick-link"><span>Services</span></a></li>
                    <li><a href="{{ route('projects') }}" class="footer-quick-link"><span>Projects</span></a></li>
                    <li><a href="{{ route('contact') }}" class="footer-quick-link"><span>Contact</span></a></li>
                </ul>
            </div>
            <div id="contact">
