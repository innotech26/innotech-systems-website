<x-public-layout>
    <section class="relative overflow-hidden bg-brand-dark py-16">
        ...
        <div class="max-w-7xl mx-auto px-4 relative">
            <h1 class="text-4xl md:text-5xl font-bold text-white">Services</h1>
            <p class="text-slate-300 mt-3 max-w-2xl">Comprehensive IT services tailored to your organization.</p>
        </div>
    </section>
